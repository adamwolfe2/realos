...
export const INTEGRATIONS: IntegrationDefinition[] = [
  ...
  },
  {
    ...
    category: "analytics",
    tagline: "Organic sessions, top pages, and engagement metrics.",
    description:
      "Paste a Google service account JSON to pull organic search sessions, users, bounce rate, and top landing pages into the portal. Lands on the SEO dashboard alongside Search Console data.",
    landsIn: ["SEO dashboard", "Top landing pages"],
    brandColor: "#F9AB00",
    initials: "Ga",
    auth: "self_serve",
  },
  {
    ...
    category: "analytics",
    tagline: "Top queries, impressions, clicks, and average position.",
    description:
      "Paste a Google service account JSON to pull search queries, impressions, clicks, CTR, and average position into the portal. Powers the keyword and ranking tables on the SEO dashboard.",
    landsIn: ["SEO dashboard", "Top organic queries"],
    brandColor: "#4285F4",
    initials: "Gs",
    auth: "self_serve",
  },
  ...
  // ------------------------------- Ads -----------------------------------
  {
    ...
    name: "Google Ads",
    category: "ads",
    tagline: "Managed Google Ads: we build and run your campaigns.",
    description:
      "Google Ads is delivered as a managed (concierge) service today, not a self-serve OAuth connection. Our team builds and runs your Search + Performance Max campaigns and pipes daily spend, CPC, conversions, and cost-per-conversion back into your Ads dashboard. Self-serve OAuth campaign editing lands later.",
    landsIn: ["Ads dashboard", "Campaigns", "Lead attribution"],
    brandColor: "#4285F4",
    initials: "Ga",
    auth: "request",
  },
  {
    ...
    name: "Meta Ads",
    category: "ads",
    tagline: "Managed Meta Ads: we build and run your campaigns.",
    description:
      "Meta Ads (Facebook + Instagram) is delivered as a managed (concierge) service today. Our team builds and runs the campaigns; daily metrics flow into the Ads dashboard alongside Google Ads. Self-serve OAuth audience + creative management arrives in a later sprint.",
    landsIn: ["Ads dashboard", "Campaigns", "Lead attribution"],
    brandColor: "#0866FF",
    initials: "Me",
    auth: "request",
