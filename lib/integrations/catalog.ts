...
export const INTEGRATIONS: IntegrationDefinition[] = [
  ...
  // ------------------------------- Ads -----------------------------------
  {
    ...
    name: "Google Ads",
    category: "ads",
    tagline: "Daily spend, clicks, and conversions in your dashboard.",
    description:
      "Connect your Google Ads account using a developer token + OAuth refresh token. We pull daily metrics for every campaign and surface spend, CPC, conversions, and cost-per-conversion in your Ads dashboard. Read-only for now; OAuth-based campaign editing lands later.",
  ...
  },
  {
    ...
    name: "Meta Ads",
    category: "ads",
    tagline: "Facebook + Instagram metrics into your dashboard.",
    description:
      "Connect Meta Ads (Facebook + Instagram) using a Business Manager System User token. Daily campaign metrics flow into the Ads dashboard alongside Google Ads. Read-only for V1; OAuth-based audience and creative management arrives in a later sprint.",
    landsIn: ["Ads dashboard", "Campaigns", "Lead attribution"],
    brandColor: "#0866FF",
    initials: "Me",
    auth: "self_serve",
