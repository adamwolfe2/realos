  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        onClick={onRefresh}
        disabled={pending}
        className="inline-flex items-center gap-1.5 rounded-[2px] border border-[var(--hair)] bg-background px-2.5 py-1 text-[11.5px] font-medium text-foreground hover:bg-secondary transition-colors disabled:opacity-60"
      >
        <span
