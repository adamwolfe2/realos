...
export function RunAppFolioSyncButton({ label = "Run sync now", subtle = false }: Props) {
  ...
  const cls = subtle
    ? "inline-flex items-center gap-1.5 rounded-none border border-primary/30 bg-card px-3 py-1.5 text-xs font-medium text-primary hover:bg-primary/10 disabled:opacity-50"
    : "inline-flex items-center gap-1.5 rounded-none bg-primary text-primary-foreground hover:bg-primary-dark transition-colors px-3 py-1.5 text-xs font-semibold hover:opacity-90 disabled:opacity-50";
