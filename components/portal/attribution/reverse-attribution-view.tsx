        ...
        <div className="mb-2 flex items-center justify-between gap-3">
          ...
          {filter ? (
            <button
              ...
              className="inline-flex items-center gap-1 rounded-full border border-border bg-muted/40 px-2.5 py-1 text-[11px] font-medium text-foreground hover:bg-muted transition-colors"
            >
