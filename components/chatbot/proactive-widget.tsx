...
// this guard the entire tenant layout crashes on first widget mount and the
// root error boundary replaces the marketing site with an error page.
// Prefers crypto.getRandomValues for entropy; only falls back to Math.random
// as a last resort. Output is RFC4122 v4 compliant either way.
