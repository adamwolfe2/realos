...
const STEPS: Step[] = [
  {
    ...
    footer: "Onboarding complete. Next: we build your dashboard, site, and campaigns.",
  },
  {
    key: "customize",
    num: "02",
    ...
    headingSub: "Every module below, built and live in fourteen days.",
    countLabel: "Modules shipped",
    rows: [
      { label: "Data analytics",                       value: "Every channel's numbers, one dashboard",     icon: "report", logos: [<GA4Mark key="ga" size={16} />, <AppFolioMark key="af" size={16} />] },
