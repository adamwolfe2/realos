...
const CAPS: Cap[] = [
  {
    ...
    headline: "See which ad actually produced the lease.",
  ...
  },
  {
    ...
    chip: "No form needed",
    headline: "Most visitors never fill out a form. See who they are anyway.",
  ...
  },
  {
    ...
    chip: "Every site",
    headline: "Watched everywhere renters look, now including AI search.",
