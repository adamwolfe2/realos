export default function PixelRequestsLoading() {
  return (
            ...
            <tbody className="divide-y divide-border">
              {Array.from({ length: 5 }).map((_, i) => (
                <tr key={i}>
                  ...
                  <td className="px-4 py-3"><div className="h-4 w-40 bg-muted/60 rounded" /></td>
                  <td className="px-4 py-3"><div className="h-4 w-24 bg-secondary rounded" /></td>
                  <td className="px-4 py-3"><div className="h-4 w-32 bg-secondary rounded" /></td>
                  <td className="px-4 py-3"><div className="h-5 w-20 bg-muted/60 rounded" /></td>
                  <td className="px-4 py-3"><div className="h-4 w-24 bg-secondary rounded ml-auto" /></td>
                </tr>
              ))}
            </tbody>
          </table>
