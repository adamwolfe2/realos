  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 lg:px-6 py-8 lg:py-12 space-y-8 animate-pulse">
      ...
      <div className="space-y-3">
        <div className="h-3 w-32 bg-primary/10 rounded-[2px]" />
        <div className="h-8 w-3/4 max-w-md bg-muted rounded-[2px]" />
        <div className="h-4 w-full max-w-xl bg-muted/60 rounded-[2px]" />
        <div className="h-4 w-2/3 max-w-md bg-muted/60 rounded-[2px]" />
      </div>
      ...
      <div className="ls-card p-4">
        <div className="flex items-baseline justify-between mb-3">
          ...
          <div className="h-3 w-12 bg-muted rounded-[2px]" />
        </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="h-4 w-1/2 bg-muted rounded-[2px]" />
                ...
                <div className="border-t border-border-soft/40 pt-3 space-y-2">
                  ...
                  <div className="h-10 rounded-[2px] bg-primary/10 mt-3" />
                </div>
              </div>
            ))}
          </div>
