  ...
  return (
    <div className="space-y-4 animate-pulse">
      <div>
        ...
        <div className="h-8 w-40 bg-muted rounded-[2px] mt-2" />
      ...
      <div className="h-8 w-full rounded-[2px] bg-secondary" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="ls-card p-4 space-y-2">
            ...
            <div className="h-6 w-14 bg-muted rounded-[2px]" />
            <div className="h-3 w-24 bg-muted/60 rounded-[2px]" />
          </div>
        ))}
      </div>
        ...
        <div className="px-5 pb-4 space-y-3">
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="flex items-start gap-2.5">
              <div className="shrink-0 h-9 w-9 rounded-[2px] bg-muted" />
              <div className="min-w-0 flex-1 space-y-1.5">
                <div className="h-3.5 w-48 bg-muted rounded-[2px]" />
                <div className="h-3 w-full max-w-md bg-muted/60 rounded-[2px]" />
              </div>
            </div>
          ))}
        </div>
