  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex gap-2">
        ...
        <div className="h-9 w-24 bg-muted/70 rounded-[2px]" />
        <div className="h-9 w-28 bg-muted/50 rounded-[2px]" />
      </div>
      <div className="space-y-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="ls-card p-5 space-y-2">
            ...
            <div className="h-5 w-3/4 bg-muted rounded-[2px]" />
            <div className="h-3 w-full bg-secondary rounded-[2px]" />
            <div className="h-3 w-5/6 bg-muted/30 rounded-[2px]" />
          </div>
        ))}
      </div>
    </div>
