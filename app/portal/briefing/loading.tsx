          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="rounded-[2px] border border-border bg-card p-4 space-y-2">
              <div className="flex items-center gap-3">
                <div className="h-8 w-8 bg-muted rounded-[2px]" />
              ...
              <div className="h-3 w-3/4 bg-muted/30 rounded-[2px]" />
            </div>
          ))}
        </div>
        <div className="space-y-4">
          <div className="rounded-[2px] border border-border bg-card p-4 space-y-3">
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="space-y-1">
                ...
                <div className="h-6 w-16 bg-muted rounded-[2px]" />
              </div>
            ))}
          </div>
          <div className="rounded-[2px] border border-border bg-card p-4 space-y-2">
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="h-9 w-full bg-muted/50 rounded-[2px]" />
            ))}
          </div>
        </div>
      </div>
