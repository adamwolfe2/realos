  ...
  return (
    <div className="space-y-6 animate-pulse">
      <div className="space-y-1">
        <div className="h-7 w-40 bg-muted rounded-[2px]" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="ls-card p-4 space-y-3"
          >
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-[2px] bg-muted" />
              <div className="h-4 w-28 bg-muted rounded-[2px]" />
            </div>
            <div className="h-3 w-full bg-muted/50 rounded-[2px]" />
            <div className="h-3 w-3/4 bg-secondary rounded-[2px]" />
