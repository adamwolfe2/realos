export default function VisitorDetailLoading() {
  return (
    <div className="animate-pulse">
      {/* Back link */}
      <div className="h-4 w-28 bg-muted/60 rounded-[2px] mb-6" />
          ...
          <div className="ls-card p-6 space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                <div className="h-6 w-40 bg-muted rounded-[2px]" />
                <div className="h-4 w-32 bg-muted/60 rounded-[2px]" />
              </div>
              ...
              <div key={i} className="p-5 space-y-3">
                ...
                <div className="flex gap-4">
                  {Array.from({ length: 3 }).map((_, j) => (
                    <div key={j} className="h-3 w-16 bg-secondary rounded-[2px]" />
                  ))}
                </div>
              </div>
            ))}
