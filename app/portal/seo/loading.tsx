  ...
  return (
    <div className="space-y-6 animate-pulse">
      <div className="space-y-1">
        <div className="h-7 w-20 bg-muted rounded-[2px]" />
      ...
      <div className="ls-card p-5 flex items-center gap-4">
        ...
        <div className="h-8 w-28 bg-muted/60 rounded-[2px]" />
      </div>
            ...
            <div className="divide-y divide-border">
              {Array.from({ length: 5 }).map((_, j) => (
                <div key={j} className="px-5 py-3 flex items-center justify-between gap-3">
                  ...
                  <div className="h-3 w-12 bg-muted/50 rounded-[2px]" />
                  <div className="h-3 w-10 bg-secondary rounded-[2px]" />
                </div>
              ))}
            </div>
          </div>
