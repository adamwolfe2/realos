...
export const metadata: Metadata = {
  ...
  description:
    "A fully-tracked property website, designed, built, and live in 14 days. Hooked up to your weekly report, your pixel, your CRM, your AI chatbot — same day it ships.",
};
...
export default function WebsiteBuildFeaturePage() {
  return (
    <FeaturePage
      ...
      subhead="We design, build, and launch your property site under your domain — fully wired to your weekly report, identity pixel, AI chatbot, CRM, and ad audiences from day one. No web agency, no 90-day discovery phase, no broken handoff to a marketing team."
      whatItIs="A production property website — designed, built, and shipped on your domain in two weeks. Every piece of LeaseStack intelligence (pixel, chatbot, popups, conversion tracking, reputation feed) is pre-wired the day the site goes live. No retrofitting, no second integration project."
      howItWorks={[
